---
layout: post
title: "Go Channels Fundamental Pattern #2: First-Response-Wins"
categories: tips
featured_image: /img/article3-golang-logo.png
---

In [Part 1](https://hamonangann.github.io/tips/2025/06/16/article6.html) we have already discussed how Go channels are used to create indefinite processes. Now, we will discuss another fundamental pattern for Go channels.
...
In [part 1](https://hamonangann.github.io/tips/2025/06/16/article6.html) we have already implemented graceful shutdown with context cancellation, in case of delay or failure on shutdown. We can modify our end of `main()`
